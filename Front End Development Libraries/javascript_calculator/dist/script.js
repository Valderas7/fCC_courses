...
class App extends React.Component {
  ...
  render() {
    ...
    return /*#__PURE__*/ (
      ...
      React.createElement("button", { className: "big-h red ac", id: "clear", onClick: this.handleClick }, "AC"),


      numbers.map((number) => /*#__PURE__*/
      React.createElement("button", { className: `grey ${number === 0 && 'big-h'}`, key: number, onClick: this.handleClick, id: numbers_operators_dict[number] }, number)), /*#__PURE__*/



      React.createElement("button", { className: "red", id: "decimal", onClick: this.handleClick }, ".")), /*#__PURE__*/



      React.createElement("div", { className: "ops-container" }, operators.map((operator) => /*#__PURE__*/
      React.createElement("button", { className: "blue", key: operator, id: numbers_operators_dict[operator], onClick: this.handleClick }, operator)), /*#__PURE__*/



      React.createElement("button", { className: "blue", onClick: this.handleClick, id: "equals" }, "="))));
