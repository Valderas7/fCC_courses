...
const App = function () {
  return /*#__PURE__*/(
    ...
    React.createElement("h1", null, "Pulsa una nota:"),
    rhythms.map((rhythm, index) => /*#__PURE__*/
    ...
    React.createElement(DrumPads, { text: rhythm.key, key: index, sound: rhythm.mp3 }))));
...
class DrumPads extends React.Component {
  ...
  render() {
    ...
    return /*#__PURE__*/(
      React.createElement("div", { className: "drum-pad box", onClick: this.playSound, id: `drum-${text}` },
      text, /*#__PURE__*/
